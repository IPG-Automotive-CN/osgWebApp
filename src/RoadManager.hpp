    ...
    */
    ...
    public:
        ...
        */
        ...
        bool LoadOpenDriveBuffer(void *buffer, size_t len, bool replace = true);
        bool LoadOpenDriveDoc(pugi::xml_node doc);
    ...
    public:
        ...
        static bool       LoadOpenDrive(void *buffer, size_t len);
